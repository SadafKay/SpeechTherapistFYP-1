                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View style={{flexDirection:'row',marginTop: 15}}>
                            ...
                            <View style={{marginLeft:15, flexDirection:'column'}}>
                                <Title style={styles.title}>Ali Ahmed</Title>
                                <Caption style={styles.caption}>ali_ahmed@gmail.com</Caption>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.section}>
                                ...
                                <Caption style={styles.caption}>Scheduled Slots</Caption>
                            </View>
                        </View>
                    </View>
                    ...
                    <Drawer.Section style={styles.drawerSection}>
                        ...
                        <DrawerItem 
                            ...
                            onPress={() => {props.navigation.navigate('BookedAppointments')}}
                        />
                    </Drawer.Section>
                </View>
            </DrawerContentScrollView>
